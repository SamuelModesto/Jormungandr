...
def slowprint(texto, atraso=0.01):
    for c in texto:
...
if choice1 == 'esquerda':
    ...
    if choice2 == 'esperar':
        ...
        *******************************************************************************
        ...
        if choice3 == 'amarelo':
            ...
            *******************************************************************************
            ''')
            slowprint('PARABENS VOCE ENCONTROU O TESOURO PERDIDO, PAGOU UMA PARTE AO SENHOR E VOLTOU AO CAPITÃO JHONY SPADER E SALVOU A SUA AMADA!')
   ...
   ***********************************************************************************
 ''')
    slowprint('VOCE CAMINHA E MESMO COM A TOCHA NAO PERCEBE UM BURACO NA SUA FRENTE, ESCORREGA E CAI EM UM BURACO PROFUNDO '
